...
class ControlField(QWidget):
    ...
    def __init__(self, parent,
        ...
        self._line_color_widget = ColorSelectionField(self, "  Выбрать цвет многоугольника  ",
        ...
        self._splitter_selector_button = QRadioButton('Ввод вершины отсекателя')
        self._splitter_selector_button.setChecked(True)
        self._splitter_selector_button.clicked.connect(change_point_select_status)

        self._line_selector_button = QRadioButton('Ввод вершины многоугольника')
        ...
        self._close_button = QPushButton("Замкнуть")
        self._close_button.clicked.connect(close_action)
        self._layout.addWidget(self._close_button)

        self._dot_co_ords = InputTwoParams(self, "Координаты вершины: ")
        self._layout.addWidget(self._dot_co_ords)
        self._add_point_button = QPushButton("Добавить новую вершину")
